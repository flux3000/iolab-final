        ...
        for (var i = 0; i < json.length; i++) {
                ...
                if (thisSightingDay == day) {
						...
						if($.inArray(json[i]["state"], stateList) !== -1){
							...
							tempDaySightingsArray.push("<strong>Shape:</strong> " + json[i]["shape"] + "&nbsp;&nbsp;<strong>Duration:</strong> " + json[i]["duration"] + "<br><br>" + json[i]["summary"] + "<div class='link' onMouseOver='this.style.opacity=1' onMouseOut='this.style.opacity=.4'><a class='sighting-item-link' href='"+json[i]["url"]+"' target='_new'>More details<img src='images/icons/external_link.png' height='10px' width='10px' style='border: none;padding-left:2px;'></a></div>");
...
function redoMapData(data, day){
	...
	if(day == undefined){
		for(var key in json){
			...
			var text = "<strong>Shape:</strong> " + json[key]["shape"] + "&nbsp;&nbsp;<strong>Duration:</strong> " + json[key]["duration"] + "<br><br>" + json[key]["summary"] + "<br><br><div class='link' onMouseOver='this.style.opacity=1' onMouseOut='this.style.opacity=.4'><a class='sighting-item-link' href='"+json[key]["url"]+"' target='_new'>More details<img src='images/icons/external_link.png' height='10px' width='10px' style='border: none;padding-left:2px;'></a></div>";
